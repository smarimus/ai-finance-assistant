#!/usr/bin/env python3
"""
Quick script to scrape financial knowledge base
Run this to start scraping financial content from various sources
"""
...
def run_scraper(max_articles=None):
    """Run the financial knowledge base scraper with optional article limit."""
    print("🚀 Starting Financial Knowledge Base Scraper")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    print(f"📊 Will scrape up to {MAX_ARTICLES} articles from financial sources")
