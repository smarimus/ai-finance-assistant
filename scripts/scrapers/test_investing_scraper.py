#!/usr/bin/env python3
"""
Test script to verify the Investing.com scraper is working correctly
"""
...
def test_investing_scraper():
    """Test the Investing.com scraper with a few URLs."""
    print("🧪 Testing Investing.com Knowledge Base Scraper...")
...
if __name__ == "__main__":
    print("🔬 Running Investing.com scraper tests...\n")
    ...
    if success1 or success2:
        print(f"\n🎉 Test passed! The Investing.com scraper is ready to use.")
        print(f"🚀 Run 'python run_investing_scraper.py' to start full scraping.")
    else:
